...
__author__ = ...
class KShape(ClusterMixin, TimeSeriesCentroidBasedClusteringMixin, BaseModelPackage, TimeSeriesBaseEstimator):
    ...
    """
    def __init__(self, n_clusters=..., max_iter=..., tol=..., n_init=..., verbose=..., random_state=..., init=...) -> None:
        ...
